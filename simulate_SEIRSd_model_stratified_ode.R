...
simulate_SEIRSd_model_stratified_ode <- function(S_h = 1000, E_h = 1, I_h = 1, R_h = 0, S_l = 1000, E_l = 1, I_l = 1, R_l = 0, bE_h = 0, bI_h = 0.002, gE_h = 1, gI_h = 1, w_h = 1, n_h = 0, m_h = 0, bE_l = 0, bI_l = 0.002, gE_l = 1, gI_l = 1, w_l = 1, n_l = 0, m_l = 0, tstart = 0, tfinal = 100, dt = 0.1) 
{ 
  ############################## 
