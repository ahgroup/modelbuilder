...
Next, see the [Get Started section](https://ahgroup.github.io/modelbuilder/articles/modelbuilder.html) for a basic and currently sparse - but hopefully still informative - introduction.


## Further information
* We developed two packages that teach the use of compartmental simulation models for use on the population level ([DSAIDE package](https://ahgroup.github.io/DSAIDE/)), and individual host/patient level ([DSAIRM package](https://ahgroup.github.io/DSAIRM/)). Those packages come with pre-coded simulations and are meant for learning, while **modelbuilder** lets you build your own models and is geared towards more advanced users.
