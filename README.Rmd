...
**This is an early version of the package, only some features are already implemented.  It should mostly work, but has not been fully tested/debugged. At the moment, the package is undergoing some major modifications. Not all bits might work. Let us know if something fails.**
