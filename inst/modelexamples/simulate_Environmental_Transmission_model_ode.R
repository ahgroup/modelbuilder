...
simulate_Environmental_Transmission_model_ode <- function(vars = c(S = 10000, I = 1, R = 0, E = 0), pars = c(bd = 1e-04, be = 1e-04, m = 0, n = 0, g = 0.2, p = 1, c = 10), times = c(tstart = 0, tfinal = 500, dt = 0.1) ) 
{ 
