...
simulate_Vector_transmission_model_stochastic <- function(Sh = 1000, Ih = 1, Rh = 0, Sv = 1000, Iv = 1, b1 = 0.002, b2 = 0.002, g = 1, w = 0.1, n = 100, m = 0.1, tstart = 0, tfinal = 100, dt = 0.1, rngseed = 123) 
{ 
