...
#' result <- simulate_Coronavirus_vaccine_model_stochastic(S = 2000,P = 2,A = 2,I = 2,H = 0,R = 0,D = 0) 
...
simulate_Coronavirus_vaccine_model_stochastic <- function(S = 1000, P = 1, A = 1, I = 1, H = 0, R = 0, D = 0, bP = 0.001, bA = 5e-04, bI = 0.001, nu = 0.3, sigma = 0.2, gammaA = 0.125, gammaI = 0.1, gammaH = 0.2, phi = 0.05, rho = 0.01, n = 1003, nuInverse = 0.7,  = ,  = , c = 1, alpha = 1, tstart = 0, tfinal = 100, dt = 0.1, rngseed = 123) 
{ 
