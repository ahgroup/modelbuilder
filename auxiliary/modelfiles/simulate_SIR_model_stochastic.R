...
#' result <- simulate_SIR_model_stochastic(S = 2000,I = 2,R = 0) 
...
simulate_SIR_model_stochastic <- function(S = 1000, I = 1, R = 0, b = 0.002, g = 1, tstart = 0, tfinal = 100, dt = 0.1, rngseed = 123) 
{ 
  #Block of ODE equations for adaptivetau 
  SIR_model_fct <- function(y, parms, t) 
  {
  ...
  simout = adaptivetau::ssa.adaptivetau(init.values = varvec, transitions = transitions,
                  	 	 	 rateFunc = SIR_model_fct, params = parvec, tf = tfinal) 
