...
#' result <- simulate_Reproductive_Number_1_stochastic() 
#' # To choose values other than the standard one, specify them like this:  
#' result <- simulate_Reproductive_Number_1_stochastic(S = 2000,I = 2,R = 0,N = 0) 
...
simulate_Reproductive_Number_1_stochastic <- function(S = 1000, I = 1, R = 0, N = 0, b = 0.002, g = 1, tstart = 0, tfinal = 100, dt = 0.1, rngseed = 123) 
{ 
  #Block of ODE equations for adaptivetau 
  Reproductive_Number_1_fct <- function(y, parms, t) 
  {
    with(as.list(c(y,parms)),   
     { 
       #specify each rate/transition/reaction that can happen in the system 
     rates = c(b*S*I, g*I, b*S/g)
     return(rates) 
      }
	 	)   
  ...
  simout = adaptivetau::ssa.adaptivetau(init.values = varvec, transitions = transitions,
                  	 	 	 rateFunc = Reproductive_Number_1_fct, params = parvec, tf = tfinal) 
