...
simulate_Environmental_Transmission_model_stochastic <- function(S = 1000, I = 1, R = 0, P = 0, bI = 0.004, bP = 0, n = 0, m = 0, g = 2, q = 0, c = 0, tstart = 0, tfinal = 60, dt = 0.1, rngseed = 123) 
{ 
