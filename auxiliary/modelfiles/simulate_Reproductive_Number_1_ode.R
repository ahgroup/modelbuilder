...
#' @param N : starting value for Reproductive number : numeric
...
#' result <- simulate_Reproductive_Number_1_ode() 
#' # To choose values other than the standard one, specify them like this:  
#' result <- simulate_Reproductive_Number_1_ode(S = 2000,I = 2,R = 0,N = 0) 
...
simulate_Reproductive_Number_1_ode <- function(S = 1000, I = 1, R = 0, N = 0, b = 0.002, g = 1, tstart = 0, tfinal = 100, dt = 0.1) 
{ 
  ############################## 
  #Block of ODE equations for deSolve 
  ############################## 
  Reproductive_Number_1_ode_fct <- function(t, y, parms) 
  {
    ...
    dR_mb = +g*I
    #Reproductive number : number reproduced :
    dN_mb = +b*S/g
    #EndODES
    list(c(dS_mb,dI_mb,dR_mb,dN_mb)) 
  ...
  varvec_mb = c(S = S, I = I, R = R, N = N) 
  parvec_mb = c(b = b, g = g) 
  timevec_mb = seq(tstart, tfinal,by = dt) 
  #Running the model 
  simout = deSolve::ode(y = varvec_mb, parms = parvec_mb, times = timevec_mb,  func = Reproductive_Number_1_ode_fct, rtol = 1e-12, atol = 1e-12) 
